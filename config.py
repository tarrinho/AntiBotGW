...
GW_VERSION = "AntiBotWaf_GW_1.9.12"
...
RISK_BAN_THRESHOLD       = int(os.environ.get("RISK_BAN_THRESHOLD", "50"))
RISK_BAN_THRESHOLD_NAT   = int(os.environ.get("RISK_BAN_THRESHOLD_NAT", "100"))
