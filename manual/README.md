...
**AppSecGW/1.4.5** is a hardened reverse HTTP proxy designed to sit in front of
...
```
       ...
       └─────────────┬─────────────┘
                     ...
                     ▼
       ┌─────────────────────────────────────┐
       │  AppSecGW/1.4.5  (Chainguard Wolfi)   │
...
`trivy image appsec-antibot-gw:1.4.5` on every rebuild to verify the posture
stays at zero.
