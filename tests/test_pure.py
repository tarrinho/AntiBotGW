...
_EXPECTED_VERSION = "AntiBotWaf_GW_1.9.12"
...
def test_no_stale_version_strings_in_source():
    ...
    stale_re = re.compile(r'AntiBotWaf_GW_(?!1\.9\.12\b)\d+\.\d+')
...
def test_vhost_policy_html_version_string():
    ...
    assert "AntiBotWaf_GW_1.9.12" in src, "vhost_policy.html: version string missing or stale"
