...
_EXPECTED_VERSION = "AppSecGW_1.8.9"
...
def test_no_stale_version_strings_in_source():
    ...
    stale_re = re.compile(r'AppSecGW_(?!1\.8\.9\b)\d+\.\d+')
...
def test_vhost_policy_html_version_string():
    ...
    assert "AppSecGW_1.8.9" in src, "vhost_policy.html: version string missing or stale"
