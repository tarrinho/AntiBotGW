...
(1.8.15, post example.com slow-fsync incident).

Production incident: example.com container had 4KB fsync = 57 ms on the
...
class TestPerformanceDocumented:
    """Source-comment guard: the example.com incident context must be in
